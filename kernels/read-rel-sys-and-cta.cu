...
__global__ void litmus_test(
  ...
  if (shuffled_workgroup < kernel_params->testing_workgroups) {
    ...
    cuda::atomic<uint, cuda::thread_scope_block>* x_1_cta = (cuda::atomic<uint, cuda::thread_scope_block>*) &test_locations[x_1];
    ...
    if (id_0 != id_1) {
      ...
      uint r0 = x_1_cta->load(cuda::memory_order_relaxed);
